...
// htmlDivElement.style.margin = '5px'
...
//     elementsByClassName.style.color = 'red'
// }
...
//     let item1 = divElement.className = 'item';
...
//         surname: 'Simpson',
//         age: 10,
//         info: 'Бартолом\'ю ДжоДжо «Барт» Сімпсон (англ. Bartholomew JoJo «Bart» Simpson) — один ' +
//             'із головних героїв мультиплікаційного серіалу Сімпсони. Барт — найстарша дитина Гомера і ' +
//             'Мардж Сімпсон. У нього також є дві молодші сестри — Ліса і Меґґі. Барт є втіленням образу бешкетника ' +
//             'та посереднього учня у школі. Разом зі своїм батьком Барт є одним із найвідоміших персонажів ' +
//             'у цьому серіалі.',
...
//             'лисий і не дуже розумний. Нерідко він поводиться як блазень, абсурдно, егоїстично і нетактовно, ' +
...
//             'и ездит на оранжевом универсале. У неё шикарные синие волосы, которые она обычно ' +
//             'собирает в очень высокую причёску. Глаза цвета ореха (19s6e). Основное занятие — ' +
//             'домохозяйка, большую часть времени проводит в заботе о доме, детях и Гомере. ' +
...
//             'нравственность не только своей семьи, но и всего города. Отлично готовит, ' +
...
//             'года семья Симпсонов получила собственный сериал на телеканале Fox, ' +
...
//
//     let divElement = document.createElement('div');
//     divElement.innerText = item.monthDuration;
//
//     let paragraphElement = document.createElement('p');
//     paragraphElement.innerText = item.hourDuration;
//
//     let htmlParagraphElement = document.createElement('p');
//     htmlParagraphElement.innerText = item.modules;
//
//     htmlDivElement.append(headingElement, divElement, paragraphElement, htmlParagraphElement);
//     document.body.append(htmlDivElement);
//
